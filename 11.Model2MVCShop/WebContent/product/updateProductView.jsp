...
<body>
	...
	<div class="container">
		...
		<div class="page-header text-center">
	       ...
	       <h5 class="text-muted">상품 정보를 <strong class="text-danger">주기적으로 갱신</strong>해 주세요.</h5>
	    </div>
		...
		<form class="form-horizontal">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="prodNo" name="prodNo" value="${product.prodNo}" placeholder="중복확인하세요"  readonly>
		       <span id="helpBlock" class="help-block">
		      	<strong class="text-danger">상품번호는 수정불가합니다.</strong>
		      </span>
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="prodName" class="form-control" id="prodName"  value="${product.prodName}" name="prodName" placeholder="상품명변경">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="prodDetail" name="prodDetail" value="${product.prodDetail}" placeholder="제품상세정보">
		    </div>
		  </div>
